    ...
    return (
        <form
            ...
            <FormField
                ...
                placeholder="Sign up @ joinmetagig.netlify.app to customize and sell this gig"
            ...
            {/* <FormField
                type="url"
                title="Gig URL"
                state={form.googledriveUrl}
                placeholder="https://joinmetagig.netlify.app"
                setState={(value) => handleStateChange('googledriveUrl', value)}
            /> */}
